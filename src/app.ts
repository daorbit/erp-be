...
import leaveFinyearRoutes from './modules/leave-finyears/leaveFinyear.routes.js';
...
import empLeaveOpeningRoutes from './modules/emp-leave-openings/empLeaveOpening.routes.js';
import optionalHolidayRoutes from './modules/optional-holidays/optionalHoliday.routes.js';
import closingLeaveTransferRoutes from './modules/closing-leave-transfers/closingLeaveTransfer.routes.js';
...
app.use(`${API_PREFIX}/leave-finyears`, leaveFinyearRoutes);
...
app.use(`${API_PREFIX}/emp-leave-openings`, empLeaveOpeningRoutes);
app.use(`${API_PREFIX}/optional-holidays`, optionalHolidayRoutes);
app.use(`${API_PREFIX}/closing-leave-transfers`, closingLeaveTransferRoutes);
