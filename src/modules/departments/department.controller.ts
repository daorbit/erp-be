...
// Department is company-scoped only.
const deptScope = (req: IAuthRequest) => scopeFilter(req.user, { branchField: null });
...
export class DepartmentController {
  ...
  static getAll = asyncHandler(async (req: IAuthRequest, res: Response) => {
    ...
    const result = await DepartmentService.getAll(query, undefined, deptScope(req));
    res.status(200).json(
  ...
  static getTree = asyncHandler(async (req: IAuthRequest, res: Response) => {
    const tree = await DepartmentService.getDepartmentTree(effectiveCompany(req.user));
    res.status(200).json(
  ...
  static getById = asyncHandler(async (req: IAuthRequest, res: Response) => {
    const department = await DepartmentService.getById(req.params.id as string, effectiveCompany(req.user));
    res.status(200).json(
  ...
  static create = asyncHandler(async (req: IAuthRequest, res: Response) => {
    const department = await DepartmentService.create({ ...req.body, company: effectiveCompany(req.user) });
    res.status(201).json(
  ...
  static update = asyncHandler(async (req: IAuthRequest, res: Response) => {
    const department = await DepartmentService.update(req.params.id as string, req.body, effectiveCompany(req.user));
    res.status(200).json(
  ...
  static delete = asyncHandler(async (req: IAuthRequest, res: Response) => {
    const department = await DepartmentService.delete(req.params.id as string, effectiveCompany(req.user));
    res.status(200).json(
  ...
  static merge = asyncHandler(async (req: IAuthRequest, res: Response) => {
    ...
    const result = await DepartmentService.merge(fromDepartment, toDepartment, effectiveCompany(req.user));
    res.status(200).json(
