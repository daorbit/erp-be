...
export const getPayrollReport = asyncHandler(async (req: Request, res: Response) => {
  ...
  const report = await ReportService.getPayrollReport(month, year);
...
export const getExpenseReport = asyncHandler(async (req: Request, res: Response) => {
  ...
  const report = await ReportService.getExpenseReport(month, year);
...
export const getHeadcountReport = asyncHandler(async (_req: Request, res: Response) => {
...
export const getTurnoverReport = asyncHandler(async (req: Request, res: Response) => {
  ...
  const report = await ReportService.getTurnoverReport(year);
